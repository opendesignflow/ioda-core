...
import org.odfi.ioda.instruments.nivisa.tektronix.{TekTronixDevice, TektronixHarvester, TekTronixOsci}
...
object TryVISA extends App {
  ...
  res = VisaLibrary
    .viFindRsrc(defaultRM.getLong, Pointer.pointerToCString("USB?*INSTR"), instrsList, numInstr, resourceString)
